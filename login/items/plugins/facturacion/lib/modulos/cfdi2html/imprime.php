...
//COMERCIO EXTERIOR 21/01/2020 J.C.
foreach ($xml->xpath('//cfdi:Comprobante//cfdi:Complemento//cce11:ComercioExterior') as $ComercioExterior)
{
    $TipoOperacion=$ComercioExterior['TipoOperacion'];
    $ClaveDePedimento=$ComercioExterior['ClaveDePedimento'];
    $CertificadoOrigen=$ComercioExterior['CertificadoOrigen'];
    $Incoterm=$ComercioExterior['Incoterm'];
    $Subdivision=$ComercioExterior['Subdivision'];
    $TipoCambioUSD=$ComercioExterior['TipoCambioUSD'];
    $TotalUSD=$ComercioExterior['TotalUSD'];
    
    $tr="
    <tr class='factura_detalles_cabecera $class'><td>TipoOperacion</td><td>ClaveDePedimento</td><td>CertificadoOrigen</td><td>Incoterm</td><td>Subdivision</td><td>TipoCambioUSD</td><td>TotalUSD</td></tr>
    <tr><td>$TipoOperacion</td><td>$ClaveDePedimento</td><td>$CertificadoOrigen</td><td>$Incoterm</td><td>$Subdivision</td><td>$$TipoCambioUSD</td><td>$$TotalUSD</td></tr>
    ";
    
}
//
foreach ($xml->xpath('//cfdi:Comprobante//cfdi:Complemento//cce11:ComercioExterior//cce11:Emisor//cce11:Domicilio') as $DomicilioEmisor)
{
    $Calle=$DomicilioEmisor['Calle'];
    $NumeroExterior=$DomicilioEmisor['NumeroExterior'];
    $Municipio=$DomicilioEmisor['Municipio'];
    $Colonia=$DomicilioEmisor['Colonia'];
    $Estado=$DomicilioEmisor['Estado'];
    $Pais=$DomicilioEmisor['Pais'];
    $CodigoPostal=$DomicilioEmisor['CodigoPostal'];
    
    $tdDomicilioEmisor="<td colspan='3'>
    <B>Emisor</b><br>
    Calle : $Calle <br>
    Num Ext : $NumeroExterior <br>
    Num Int : $Municipio <br>
    Estado : $Estado <br>
    Colonia : $Colonia <br>
    Pais : $Pais <br>
    C.P. : $CodigoPostal <br>
...
//
foreach ($xml->xpath('//cfdi:Comprobante//cfdi:Complemento//cce11:ComercioExterior//cce11:Receptor//cce11:Domicilio') as $DomicilioReceptor)
{
    $CalleR=$DomicilioReceptor['Calle'];
    $NumeroExteriorR=$DomicilioReceptor['NumeroExterior'];
    $MunicipioR=$DomicilioReceptor['Municipio'];
    $ColoniaR=$DomicilioReceptor['Colonia'];
    $EstadoR=$DomicilioReceptor['Estado'];
    $PaisR=$DomicilioReceptor['Pais'];
    $CodigoPostalR=$DomicilioReceptor['CodigoPostal'];
    
    $tdDomicilioReceptor="<td colspan='2'>
    <B>Receptor</b><br>
    Calle : $CalleR <br>
    Num Ext : $NumeroExteriorR <br>
    Num Int : $MunicipioR <br>
    Estado : $EstadoR <br>
    Colonia : $ColoniaR <br>
    Pais : $PaisR <br>
    C.P. : $CodigoPostalR <br>
    </td>";
    
}
//
foreach ($xml->xpath('//cfdi:Comprobante//cfdi:Complemento//cce11:ComercioExterior//cce11:Destinatario//cce11:Domicilio') as $DomicilioDestinatario)
{
    $CalleD=$DomicilioDestinatario['Calle'];
    $NumeroExteriorD=$DomicilioDestinatario['NumeroExterior'];
    $MunicipioD=$DomicilioDestinatario['Municipio'];
    $ColoniaD=$DomicilioDestinatario['Colonia'];
    $EstadoD=$DomicilioDestinatario['Estado'];
    $PaisD=$DomicilioDestinatario['Pais'];
    $CodigoPostalD=$DomicilioDestinatario['CodigoPostal'];
    
    $tdDomicilioDestinatario="<td colspan='2'>
    <B>Destinatario</b><br>
    Calle : $CalleD <br>
    Num Ext : $NumeroExteriorD <br>
    Num Int : $MunicipioD <br>
    Estado : $EstadoD <br>
    Colonia : $ColoniaD <br>
    Pais : $PaisD <br>
    C.P. : $CodigoPostalD <br>
    </td>";
    
}

$tr_domicilios_CE="
<TR>$tdDomicilioEmisor $tdDomicilioReceptor $tdDomicilioDestinatario </TR>
";

//
$trMercancias.="
    <tr class='factura_detalles_cabecera $class'>
        <td>NoIdentificacion</td>
        <td colspan='2'>FraccionArancelaria</td>
        <td>CantidadAduana</td>
        <td>UnidadAduana</td>
        <td>ValorUnitarioAduana</td>
        <td>ValorDolares</td>
    </tr>";
foreach ($xml->xpath('//cfdi:Comprobante//cfdi:Complemento//cce11:ComercioExterior//cce11:Mercancias//cce11:Mercancia') as $Mercancia)
{

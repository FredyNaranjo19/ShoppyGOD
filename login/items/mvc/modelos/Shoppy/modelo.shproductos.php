...
class ShProductos{
    ...
    static public function shgetCategoriesProductos(){
        ...
        $conex = Conexion::conectar()->prepare("SELECT * FROM tv_categorias");
        //! Se asignan datos
     ...
     * @return void
     */
    static public function shShowLimitProducts($tabla){
     ...
     * @return void
     */
    static public function shgetProveedorProductos($idProveedor){
    ...
    static public function shgetProductDescripcion($idProducto){
    ...
    static public function shMostrarProductoInfoCompleta($item, $valor){
    ...
    static public function shMostrarInformacionGeneralProducto($tabla, $item, $valor){
    ...
    static public function shMostrarPreciosProductos($tabla, $datos){
    ...
    static public function shMostrarCalculosEnvioProducto($tabla, $datos){
    ...
    static public function shMostrarProductosAzar($tabla, $empresa, $noProductos){
    ...
    static public function shMostrarProductosRelacionadosCategoria($tabla, $datos, $noProductos){
    ...
    static public function shProductoFavorito($tabla, $datos){
    ...
    static public function shCrearProductoFavorito($tabla, $datos){
    ...
    static public function shEliminarProductoFavorito($tabla, $datos){
    ...
    static public function shMostrarComentariosProducto($dato){
    ...
    static public function shMostrarProductosDiferente($datos){
    ...
    static public function shGuardarComentarioProducto($tabla, $datos){
    ...
    static public function shUpdateComentarioProducto($datos){
    ...
    static public function shObtenerPuntuacionProducto($datos){
    ...
    static public function shPaginacionProductosBusqueda($datos){
    ...
    static public function shPaginacionProductos($tabla, $datos){
    ...
    static public function shPaginacionProductosCategoria($tabla, $datos){
    ...
    static public function shModificarPuntuacionProductos($datos){
    ...
    static public function shVerificarCompra($producto, $cliente){
    ...
    static public function shVerificarComentario($producto, $cliente){
    ...
    static public function shPaginacionComentarios($producto){

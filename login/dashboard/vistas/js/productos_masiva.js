...
/*=====================================================
=            CAMBIO DE VALOR EN INPUT FILE            =
=====================================================*/

$('#fileContacts').on('change', function(){
    ...
    if ($(this).val() != '') {
        ...
        if(ext == "xlsx"){
        	...
        	$(".custom-file-label").text(archivo[2]);

        } else {

            $(this).val('');
            Swal.fire("Mensaje De Error","Extensión no permitidaa: " + ext+"","error");
...
/*=====  End of CAMBIO DE VALOR EN INPUT FILE  ======*/
...
$(document).on("submit", "#filesForm", function(e){
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            //limpiar texto con nombre del archivo cargado
            $(".lbTextoArchivo").html("");
            for (var i = 0; i < data.length; i++) {
                ...
                $("#tbodyPrecarga").append("<tr class='trProductoPrecarga' idproducto='"+data[i]["id_precarga"]+"'>"+
                                                "<th class='sticky'>"+
                                                    "<div class='input-group mb-3'>"+
                                                        ...
                                                        "<div class='input-group-prepend' style='width: 70%;'>"+
                                                            "<button style='width: 100%;' class='btn btn-danger btn-sm btnEliminarProductoPrecargado' idProducto='"+data[i]["id_precarga"]+"'>"+
                                                ...
                                                "</td>"+
                                                "<td>"+
                                                    "<input type='text' class='form-control inputPrecarga' campo='promo' value='"+data[i]["p_sugerido"]+"' style='width: 75px;'>"+
                                                "</td>"+
                                                "<td>"+
                                                ...
                                                "<td></td>"+
                                                "<td>"+
                                                    "<input type='text' class='form-control inputPrecarga' campo='clvprod' value='"+data[i]["sat_clave_prod_serv"]+"' style='width: 75px;'>"+
                                                "</td>"+
                                                "<td>"+
                                                    "<input type='text' class='form-control inputPrecarga' campo='clvunid' value='"+data[i]["sat_clave_unidad"]+"' style='width: 75px;'>"+
                                                "</td>"+
                                            "</tr>");
...
=============================================================================================================================*/
    ...
    $(document).on("click", ".btnDefinirCaracteristicasPrecarga", function(){
        // limiar el div de caracteristicas
        $(".divCarcteristicasPrecarga").html("");
              ...
              denyButtonText: `Cancelar`,
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        position: 'center',
                        icon: 'success',
                        title: 'Los productos se subieron correctamente',
                        showConfirmButton: false,
                        timer: 1500
                      })
              ...
              denyButtonText: `Cancelar`,
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                      position: 'center',
                      icon: 'success',
                      title: 'Los productos se eliminaron de la lista',
                      showConfirmButton: false,
                      timer: 1500
                    })
                }
